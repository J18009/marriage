...
<?php
  ...
  //DB内の投稿内容を取得する
  $grs = $db->query('SELECT marriage_id FROM marriage ORDER BY marriage_id DESC LIMIT 1');
  $grs->execute();
  $gr = $grs->fetch();
  ...
  header('Location: family_confirm.php');
  exit();
  }
  }
?>
...
<input type="submit" name="send" value="送信" onClick="location.href='family_confirm.php'">
</div> -->
</form>
</html>
