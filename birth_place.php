...
<head>
<title>出身地選択</title>
<link rel="stylesheet" href="birth_place.css">
</head>
<ul class="townList2">
    <li>
      <div>出身地</div>
      ...
      <li>
        ...
        <div>中部地域</div>
          ...
          <li>
			    <input type="radio" class="btn_input2" id="fujieda2" name="birth_place" value="牧之原市" onclick="townChange2();">
			    <label for=fujieda2 class="btn_label2">牧之原市
		      </label>
          </li>
          <li>
        ...
        <div>賀茂地域</div>
          ...
          <li>
			    <input type="radio" class="btn_input2" id="matsuzaki2" name="birth_place" value="33"  onclick="townChange2();">
			    <label for=matsuzaki2 class="btn_label2">松崎町
		      </label>
          </li>
          <li>
			    <input type="radio" class="btn_input2" id="nishiizu2" name="birth_place" value="34"  onclick="townChange2();">
...
<!-- JavaScriptの読み込み -->
<script type="text/javascript" src="js\birth_place_indication.js"></script>
